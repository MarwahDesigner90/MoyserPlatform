"""
Django settings for MoyserWebsite project.
...
SECRET_KEY = 'django-insecure-52qn6iz6&vn*&qh5(k#+3*e2a%=h3gqab83wqkqj4bdft)+^$c'
...
ROOT_URLCONF = 'MoyserWebsite.urls'
...
WSGI_APPLICATION = 'MoyserWebsite.wsgi.application'
